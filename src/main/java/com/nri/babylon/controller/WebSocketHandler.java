...
import com.nri.babylon.model.UserSession;
...
public class WebSocketHandler extends TextWebSocketHandler {
    ...
    private void handleProcessSdpOffer(WebSocketSession session, JsonObject jsonMessage) {
        ...
        RecorderEndpoint recordMyAudio = new RecorderEndpoint.Builder(pipeline, "http://192.168.50.36:8080/acceptAudio").withMediaProfile(MediaProfileSpecType.WEBM_AUDIO_ONLY).build();
        webRtcEp.connect(recordMyAudio, MediaType.AUDIO);
        recordMyAudio.record();

        //Playback the translated audio
        PlayerEndpoint receivedAudio = new PlayerEndpoint.Builder(pipeline, "http://192.168.50.36:8080/sendAudio").build();
