...
public class UserSession implements Closeable {
    ...
    public UserSession(final String name, Room realRoom, final WebSocketSession session,
        ...
        try {
            AudioUtils.makeDirectories(new File(saveAudioPath + "/" + saveAudioName));
        } catch (AudioInterceptorException e) {
            e.printStackTrace();
        }
    ...
    public void startRecording(int count) {
        ...
        String fileNamePath = saveAudioPath + "/" + count + "_" + saveAudioName;
        RecorderEndpoint recordMyAudio = new RecorderEndpoint
                .Builder(pipeline, "file:///" + fileNamePath)
    ...
    public String getRoomName() {
        return this.realRoom.getName();
    }

    public void receiveVideoFrom(UserSession sender, String sdpOffer) throws IOException {
        log.info("USER {}: connecting with {} in room {}", this.name, sender.getName(), this.realRoom.getName());
    ...
    public boolean equals(Object obj) {
        ...
        eq &= realRoom.getName().equals(other.realRoom.getName());
        return eq;
    }
    ...
    public int hashCode() {
        ...
        result = 31 * result + realRoom.getName().hashCode();
        return result;
    }
